...
public class Traits {
    ...
    public Integer assertiveness;
    public Integer composure;
    public Integer confidence;
    public Integer credibility;
    public Integer curiosity;
    public Integer empathy;
    public Integer focus;
    public Integer humility;
    public Integer influence;
    public Integer need_for_achievement;
    public Integer openness_to_differences;
    public Integer optimism;
    public Integer persistence;
    public Integer risk_taking;
    public Integer situational_self_awareness;
    public Integer sociability;
    public Integer tolerance_of_ambiguity;
    ...
    public String toString() {
        return "Traits{" +
                ...
                ", openness_to_differences=" + openness_to_differences +
                ", optimism=" + optimism +
                ", persistence=" + persistence +
                ", risk_taking=" + risk_taking +
                ", situational_self_awareness=" + situational_self_awareness +
                ", sociability=" + sociability +
                ", tolerance_of_ambiguity=" + tolerance_of_ambiguity +
                ", trust=" + trust +
                '}';
    }
}
