...
public class Competencies {
    public String wwid;
    public Integer action_oriented;
    public Integer balances_stakeholders;
    public Integer being_resilient;
    public Integer builds_effective_teams;
    public Integer builds_networks;
    public Integer collaborates;
    public Integer communicates_effectively;
    public Integer courage;
    public Integer cultivates_innovation;
    public Integer customer_focus;
    public Integer decision_quality;
    public Integer develops_talent;
    public Integer directs_work;
    public Integer drives_engagement;
    public Integer drives_results;
    public Integer ensures_accountability;
    public Integer global_perspective;
    public Integer instills_trust;
    public Integer interpersonal_savvy;
    public Integer manages_ambiguity;
    public Integer manages_conflict;
    public Integer nimble_learning;
    public Integer optimizes_work_processes;
    public Integer persuades;
    public Integer plans_and_aligns;
    public Integer resourcefulness;
    public Integer self_development;
    public Integer situational_adaptability;
    public Integer strategic_mindset;
    public Integer values_differences;
    ...
    public String toString() {
        return "Competencies{" +
                ...
                ", balances_stakeholders=" + balances_stakeholders +
                ", being_resilient=" + being_resilient +
                ", builds_effective_teams=" + builds_effective_teams +
                ", builds_networks=" + builds_networks +
                ", collaborates=" + collaborates +
                ", communicates_effectively=" + communicates_effectively +
                ", courage=" + courage +
                ", cultivates_innovation=" + cultivates_innovation +
                ", customer_focus=" + customer_focus +
                ", decision_quality=" + decision_quality +
                ", develops_talent=" + develops_talent +
                ", directs_work=" + directs_work +
                ", drives_engagement=" + drives_engagement +
                ", drives_results=" + drives_results +
                ", ensures_accountability=" + ensures_accountability +
                ", global_perspective=" + global_perspective +
                ", instills_trust=" + instills_trust +
                ", interpersonal_savvy=" + interpersonal_savvy +
                ", manages_ambiguity=" + manages_ambiguity +
                ", manages_conflict=" + manages_conflict +
                ", nimble_learning=" + nimble_learning +
                ", optimizes_work_processes=" + optimizes_work_processes +
                ", persuades=" + persuades +
                ", plans_and_aligns=" + plans_and_aligns +
                ", resourcefulness=" + resourcefulness +
                ", self_development=" + self_development +
                ", situational_adaptability=" + situational_adaptability +
                ", strategic_mindset=" + strategic_mindset +
                ", values_differences=" + values_differences +
                '}';
    }
}
